...
<html>
    ...
    <body>
        <main>
            ...
            <section id="section2">
                ...
                <form id="form">
                    ...
                    <!-- radio button -->
                    <div id="radio-button">
                        <input type="radio" name="user" value="Uus_kasutaja" checked>Uus kasutaja<br>
                        <input type="radio" name="user" value="Konto_olemas">Mul on konto<br>
                    </div>
                    <!-- checkbox --->
        ...
        <script type='text/javascript' src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=[AhGhZ-kNs-_3q0iqaynppJStvhH4mqt6S4zWhrfm9u7V4qHGPYPgkuA1AkZguL_g]' async defer></script>
    </body>
</html>
